...
// const reportBestSubject = () => {
//   const arraySubjects = estudantes.map((student) => {
//     return {
//       name: student.name,
//       materia: bestSubject(student),
//     }
//     });
//   return arraySubjects;
// }

// const bestSubject = (student) => { 
//   student.materias.reduce((accumulator, subject) => {
//   if (subject.nota > accumulator.nota) {
//     return subject.name;
//   }
