...
// Como você pode perceber, ao aplicar o Object.entries no nosso objeto, o retorno foi um array de arrays. Em que a primeira entrada de cada array é a chave do objeto em formato de string e o segundo valor é seu respectivo valor, que pode ser uma string ou outro tipo de dado, como o número de temporadas do exemplo, que é um number. Bem legal, não é mesmo? Vamos então agora ler a documentação até a seção "Convertendo um Object em um Map".
