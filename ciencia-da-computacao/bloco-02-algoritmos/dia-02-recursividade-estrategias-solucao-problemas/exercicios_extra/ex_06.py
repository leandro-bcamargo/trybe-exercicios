...
def is_anagram(first_string, second_string):
    ...
    merge_sort(first_string_sorted, 0, len(first_string_sorted))
    merge_sort(second_string_sorted, 0, len(second_string_sorted))
    first_string_sorted = "".join(first_string_sorted)
    second_string_sorted = "".join(first_string_sorted)
