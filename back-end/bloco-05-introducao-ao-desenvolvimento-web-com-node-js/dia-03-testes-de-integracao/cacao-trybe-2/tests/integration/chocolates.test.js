...
describe('Testando a API Cacao Trybe', function () {
  ...
  describe('Usando o método GET em /chocolates/search', function() {
    it('Pesquisa chocolates pelo nome "Mo"', async function() {
    ...
    it('Pesquisa chocolates pelo nome "ZZZ"', async function() {
  ...
  describe('Usando o método PUT em /chocolates/:id', function () {
    ...
    it('Se o id não existe, retorna erro com status 404', async function() {
