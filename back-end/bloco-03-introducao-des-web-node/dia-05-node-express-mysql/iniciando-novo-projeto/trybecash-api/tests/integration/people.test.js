...
describe("Testando o endpoint de people", function () {
  ...
  it("Testando a alteração da pessoa com id 1", async function () {
    const newData = {
      firstName: "Lucão",
    ...
    const response = await chai.request(app).put("/people/1").send(newData);
