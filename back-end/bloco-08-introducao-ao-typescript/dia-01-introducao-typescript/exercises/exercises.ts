...
export function getRhombusArea (biggerDiag: number, smallerDiag: number): number {
  return (biggerDiag * smallerDiag) / 2
}

export function getTrapezoidArea (biggerBase: number, smallerBase:number, height:number): number {
